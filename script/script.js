...
const formImage = document.querySelector('.image-popup__form');
const closeButtonFormImage = document.querySelector('#popupImageClose');
const addImageButton = document.querySelector('.profile__add-button');
const nameImage = document.querySelector('.image-popup__input_name');
const linkImage = document.querySelector('.image-popup__input_link');
